...
model_name = 'colorRich_low_resolution_model.h5'
file_name ='colorRich_low_resolution.txt'
...
x_train = ktf.image.resize_images(x_train, (16, 16))
x_val = ktf.image.resize_images(x_val, (16, 16))
x_test = ktf.image.resize_images(x_test, (16, 16))
